...
- **Gemini 2.0 Flash Integration**: Context-aware fairness auditing that provides human-like reasoning for detected biases.
- **Automated Recommendations**: LLM-generated technical strategies to resolve specific disparate impact issues.
- **AI-Powered Reporting**: Comprehensive executive summaries generated by Google's latest generative models.

---

## ☁️ Google Cloud Architecture

FairLens AI is built to be **Google Cloud Native**:
- **Google Cloud Run**: The backend is containerized (Dockerfile included) and ready for serverless deployment.
- **Google Gemini API**: Uses the Google Generative AI SDK for all intelligent auditing features.
- **Google Cloud Build**: Configured for automated CI/CD from GitHub to GCP.
...
│   ├── services/
│   │   ├── ai_insight_service.py # Google Gemini Integration
```
...
- **Cloud**: **Google Cloud Run** (Architecture ready), Netlify (Frontend)
